...
alias lats='cd ~/Documents/ML-Control-Rob/LatentLearner/robots'
alias mlcont='cd ~/Documents/ML-Control-Rob'
alias reach='cd ~/Documents/ML-Control-Rob/Reachability'
alias lev='cd ~/Documents/ML-Control-Rob/Reachability/LevelSetPy'
alias lbrat='cd ~/Documents/ML-Control-Rob/Reachability/LargeBRAT'
alias part='cd ~/Documents/ML-Control-Rob/Reachability/PartiGames'
alias msr='cd ~/Documents/MSRProjs'
alias igl='cd ~/Documents/MSRProjs/IGL'
...
alias lyap='cd ~/Documents/ML-Control-Rob/LyapunovLearner'
